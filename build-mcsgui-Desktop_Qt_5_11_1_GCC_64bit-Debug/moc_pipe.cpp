...
QT_MOC_LITERAL(4, 16, 13), // "doubleClicked"
QT_MOC_LITERAL(5, 30, 12) // "pipeModified"

    },
    "Pipe\0clicked\0\0i\0doubleClicked\0"
    "pipeModified"
};
...
void Pipe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->pipeModified(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Pipe::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pipe::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Pipe::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pipe::doubleClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Pipe::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pipe::pipeModified)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Pipe::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Pipe.data,
      qt_meta_data_Pipe,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 1
void Pipe::doubleClicked(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
